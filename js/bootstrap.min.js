...
(function(t) {
    ...
    (a.prototype.keydown = function(i) {
        if (
            ...
            if (
                (i.preventDefault(),
                    i.stopPropagation(), !o.is(".disabled, :disabled"))
            ) {
                var n = e(o),
                    a = n.hasClass("open");
    ...
    (i.prototype.show = function() {
        ...
        if (
            (o ||
                ((o = e.attr("href")), (o = o && o.replace(/.*(?=#[^\s]*$)/, ""))), !e.parent("li").hasClass("active"))
        ) {
            ...
            if (
                (n.trigger(s),
                    e.trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented())
            ) {
                var r = t(o);
