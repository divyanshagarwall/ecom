...
!(function(t) {
    ...
    function F(t, e) {
        ...
        if (l > a && o < u)
            return (
                ...
                l <= u ? ((i = l.clone()), (s = !0)) : ((i = u.clone()), (s = !1)), { start: n, end: i, isStart: r, isEnd: s }
            );
    }
    ...
    function A(t, e) {
        var n, i, r;
        for (
            n = 0; n < Yt.length && ((i = Yt[n]), (r = V(i, t, e)), !(r >= 1 && ot(r))); n++
        );
        return i;
    }
    ...
    function zt() {
        ...
        function u(t, e) {
            var n, i;
            for (
                "reset" === e ? (nt = []) : "add" !== e && (nt = C(nt, t)), n = 0; n < t.length; n++
            )
                (i = t[n]),
    ...
    le.mixin({
            ...
            buildBusinessHourEvents: function(e, n) {
                ...
                return (
                    ...
                    (i = r.computeBusinessHourEvents(e, n)), !i.length &&
                    n &&
                    (i = [
                        t.extend({}, we, {
                            start: this.view.end,
    ...
    var ae = (Ot.DayTableMixin = {
            ...
            renderHeadDateCellHtml: function(t, e, n) {
                ...
                return (
                    ...
                    (n ? " " + n : "") +
                    ">" +
                    i.buildGotoAnchorHtml({ date: t, forceOff: this.rowCnt > 1 || 1 === this.colCnt },
            ...
            renderNumberCellHtml: function(t) {
                ...
                return this.view.dayNumbersVisible || this.view.cellWeekNumbersVisible ?
                    ((e = this.getDayClasses(t)),
                        ...
                        this.view.cellWeekNumbersVisible &&
                        t.day() == n &&
                        (i += this.view.buildGotoAnchorHtml({ date: t, type: "week" }, { class: "fc-week-number" },
                            t.format("w")
                        )),
                        this.view.dayNumbersVisible &&
                        (i += this.view.buildGotoAnchorHtml(
                            t, { class: "fc-day-number" },
                            t.date()
                        )),
                        (i += "</td>")) :
                    "<td/>";
    ...
    ue.mixin({
        ...
        ue.mixin({
                ...
                return t('<a class="fc-more"/>')
                    ...
                    .on("click", function(o) {
                        ...
                        "function" == typeof l &&
                            (l = s.publiclyTrigger(
                                "eventLimitClick",
                                null, { date: a, dayEl: c, moreEl: u, segs: h, hiddenSegs: f },
                                o
                            )),
                            "popover" === l ?
            ...
            renderSegPopoverContent: function(e, n, i) {
                ...
                for (
                    i = this.renderFgSegEls(i, !0), this.popoverSegs = i, r = 0; r < i.length; r++
                )
                    this.hitsNeeded(),
            ...
            getCellSegs: function(t, e, n) {
                for (
                    var i, r = this.rowStructs[t].segMatrix, s = n || 0, o = []; s < r.length;
        ...
        renderSlatRowHtml: function() {
            for (
                var t,
                    ...
                    s = this.isRTL,
                    o = "",
                    l = e.duration(+this.minTime); l < this.maxTime;
    ...
    ce.mixin({
        ...
        renderHelperSegs: function(e, n) {
            var i,
                ...
                o = [];
            for (
                e = this.renderFgSegsIntoContainers(e, this.helperContainerEls), i = 0; i < e.length; i++
            )
                (r = e[i]),
                n &&
                n.col === r.col &&
        ...
        renderFgSegsIntoContainers: function(t, e) {
            var n, i;
            for (
                t = this.renderFgSegEls(t), n = this.groupSegsByCol(t), i = 0; i < this.colCnt; i++
            )
    ...
    var de = (Ot.View = ct.extend(Jt, te, {
            ...
            publiclyTrigger: function(t, e) {
                ...
                return n.publiclyTrigger.apply(
                    n, [t, e || this].concat(Array.prototype.slice.call(arguments, 2), [
                        this,
                    ])
                );
            },
            ...
            computePrevDate: function(t) {
                return this.massageCurrentDate(
                    t.clone().startOf(this.intervalUnit).subtract(this.intervalDuration), -1
                );
            },
            ...
            captureScroll: function() {
                return (!this.capturedScrollDepth++ &&
            ...
            computeDayRange: function(t) {
                ...
                return (
                    ...
                    (!i || r <= n) && (r = n.clone().add(1, "days")), { start: n, end: r }
                );
            },
        ...
        buildSelectSpan: function(t, e) {
            ...
            return (
                (n = e ?
                    ...
                    i.clone().add(this.defaultAllDayEventDuration)), { start: i, end: n }
            );
        },
    }));
    fe.mixin(Jt),
        ...
        be = {
            ...
            renderNumberIntroHtml: function(t) {
                ...
                return e.colWeekNumbersVisible ?
                    ...
                    ">" +
                    e.buildGotoAnchorHtml({ date: n, type: "week", forceOff: 1 === this.colCnt },
                        n.format("w")
                    ) +
                    "</td>" :
                    "";
            ...
            renderHeadIntroHtml: function() {
                ...
                return e.opt("weekNumbers") ?
                    ((t = this.start.format(e.opt("smallWeekFormat"))),
                        ...
                        e.axisStyleAttr() +
                        ">" +
                        e.buildGotoAnchorHtml({ date: this.start, type: "week", forceOff: this.colCnt > 1 },
                            tt(t)
                        ) +
                        "</th>") :
                    '<th class="fc-axis ' +
    ...
    var Ie = de.extend({
        ...
        ke = le.extend({
            ...
            spanToSegs: function(t) {
                for (
                    var e, n = this.view, i = n.start.clone().time(0), r = 0, s = []; i < n.end;
                ...
                return (
                    ...
                    (n ?
                        e.buildGotoAnchorHtml(
                            t, { class: "fc-list-heading-main" },
                            tt(t.format(n))
                        ) :
                        "") +
                    (i ?
                        e.buildGotoAnchorHtml(
                            t, { class: "fc-list-heading-alt" },
                            tt(t.format(i))
                        ) :
                        "") +
                    "</td></tr>"
